...
class ExpandTouchListener implements View.OnTouchListener {
    ...
    private final NestedScrollView absListView;
    ...
    public static ExpandTouchListener newListener(Context context, NestedScrollView listView, View container,
    ...
    private ExpandTouchListener(Context context, NestedScrollView absListView, View container, int gravity,
