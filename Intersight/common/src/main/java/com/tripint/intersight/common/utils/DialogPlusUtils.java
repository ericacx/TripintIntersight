package com.tripint.intersight.common.utils;
...
import com.tripint.intersight.common.widget.dialogplus.Holder;
import com.tripint.intersight.common.widget.dialogplus.OnBackPressListener;
import com.tripint.intersight.common.widget.dialogplus.OnCancelListener;
...
public class DialogPlusUtils {
    ...
    private int contentBackgroundResource = android.R.color.white; //R.drawable.bg_border_white
...
//                .setOverlayBackgroundResource(R.drawable.bg_border_white)
