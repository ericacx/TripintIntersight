package com.tripint.intersight.common.widget.flipview;
...
public interface OverFlipper {
    ...
    /**
     * @param flipDistance    the current flip distance
     * @param minFlipDistance the minimum flip distance, usually 0
     * @param maxFlipDistance the maximum flip distance
    ...
    /**
     * @param v the view to apply any drawing onto
