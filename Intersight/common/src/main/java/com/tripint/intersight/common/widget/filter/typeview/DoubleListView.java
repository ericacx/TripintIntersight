package com.tripint.intersight.common.widget.filter.typeview;
...
import com.tripint.intersight.common.widget.filter.adapter.BaseBaseAdapter;
...
public class DoubleListView<LEFTD, RIGHTD> extends LinearLayout implements AdapterView.OnItemClickListener {
    ...
    private void init(Context context) {
        ...
        inflate(context, R.layout.ddm_merge_filter_list, this);
