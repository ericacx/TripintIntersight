...
public class PullToRefreshView extends LinearLayout {
    ...
    private void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.ptr_refresh_header, this, false);
    ...
    private void addFooterView() {
        // footer view
        mFooterView = mInflater.inflate(R.layout.ptr_refresh_footer, this, false);
    ...
    public void onHeaderRefreshComplete() {
        ...
        mHeaderImageView.setImageResource(R.drawable.ptr_goicon);
        mHeaderTextView.setText("下拉刷新");
    ...
    public void onFooterRefreshComplete() {
        ...
        mFooterImageView.setImageResource(R.drawable.ptr_goicon);
        mFooterTextView.setText("上拉加载更多");
     ...
     * 是否开启上拉加载更多功能
     *
     * @param enablePullLoadMoreDataStatus true为开启 false 禁用下拉刷新功能
     */
