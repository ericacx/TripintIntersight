package com.tripint.intersight.common.flowlayout;
...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    private int mSelectedMin = 0; //最小数默认为0
    ...
    public TagFlowLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mSelectedMin = ta.getInt(R.styleable.TagFlowLayout_min_select, -1);
        ta.recycle();
    ...
    public interface OnSelectListener {
        void onSelected(Set<Integer> selectPosSet, boolean isSelect);
    }
    ...
    private void doSelect(TagView child, int position) {
        if (mAutoSelectEffect) {
            if (!child.isChecked()) {
                ...
                if (mOnSelectListener != null) {
                    mOnSelectListener.onSelected(new HashSet<Integer>(mSelectedView), false);
                }
            }
        }
    }
