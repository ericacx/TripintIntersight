...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_PERMISSIONS =
            "springtour.permission.extra_permission"; // 权限参数
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page_permissions_activity);
...
//
//        Dialog dialog = DialogFactory.showSimpleWarnDialog(this, "帮助", "当前应用缺少必要权限。\n\n请点击\"设置\"-\"权限\"-打开所需权限。\n\n最后点击两次后退按钮，即可返回。",
//                "设置", "退出", new View.OnClickListener() {
//                    @Override
