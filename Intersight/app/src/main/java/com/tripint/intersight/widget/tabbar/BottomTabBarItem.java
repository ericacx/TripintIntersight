package com.tripint.intersight.widget.tabbar;
 ...
 */
public class BottomTabBarItem extends FrameLayout {
    ...
    public BottomTabBarItem(Context context, AttributeSet attrs, int icon, CharSequence title) {
